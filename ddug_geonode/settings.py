...
from ddug_geonode import get_version
from ddug_geonode.celeryapp import app  # flake8: noqa
import djcelery
...
SECRET_KEY = os.getenv('SECRET_KEY', "g)b9-saz@31%y!1-!pf38iz5$7vw3dg7n7_%&^)clbzobm$(*l")
...
ROOT_URLCONF = os.getenv('ROOT_URLCONF', 'ddug_geonode.urls')
...
_DEFAULT_PYSCSW = {
    ...
    'CONFIGURATION': {
        ...
        #},
        'metadata:main': {
            'identification_title': 'ddug_geonode Catalogue',
            ...
            'identification_keywords': 'sdi,catalogue,discovery,metadata,GeoNode, ddug_geonode',
